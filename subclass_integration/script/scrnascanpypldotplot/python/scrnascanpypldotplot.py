...
if __name__ == '__main__':
	...
	sc.pl.dotplot(x, marker, groupby=groupby, use_raw=False, dendrogram=dendrogram, mean_only_expressed=meanexpr, log=log, show=False, swap_axes=False, title=groupby, save=f'{bname}.png')
